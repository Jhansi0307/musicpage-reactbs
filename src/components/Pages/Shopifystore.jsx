...
//   useEffect(() => {
//     const value = async () => {
//       const response = await axios.get("http://localhost:8000/searched", data);
...
//     setTimeout(() => {
//       axios
//         .get("http://localhost:8000/getshopify")
//         .then((res) => {
...
//               <PageviewSharpIcon
//                 className="sizeofsearchshopify rounded-right"
//                 onClick={clearData}
//               />
//             </span>
//           </span>
...
function Shopifystore() {
  ...
  useEffect(() => {
    const value = async () => {
      const response = await axios.post("http://localhost:8000/searched", data);
      console.log(response.data);
      console.log(post.count);
      setPost((previous) => ({
        ...previous,
  ...
  useEffect(() => {
    setTimeout(() => {
      axios
        .get(
          `http://localhost:8000/getshopify/${pagination.limit}/${pagination.skip}`
        )
        .then((res) => {
          console.log(res.data);
          setPost({ count: res.data.count, value: res.data.value });
